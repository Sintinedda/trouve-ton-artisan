                        ...
                        <div className="artisan-card-container" key={artisan.id}>
                            <Link to={`/artisan/:${artisan.id}`}>
                                <div className="artisan-card">
                                    ...
                                    <p className="artisan-card-txt"><strong>Note : </strong><Rating className="top-stars" initialValue={artisan.note} readonly allowFraction size={25} fillColor="#0074c7" emptyColor="#9acbee"/></p>
